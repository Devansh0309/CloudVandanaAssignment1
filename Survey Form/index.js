...
function addSubmAttributes() {
  ...
  console.log(err)
  if (!err && firstNameFilled && lastNameFilled && emailFilled && professionFilled && phoneNumberFilled && countryFilled && dateSelected && genderChecked && tncChecked) {
...
function reset() {
  ...
  genderChecked=false
  tncChecked=false
  subm.setAttribute("data-bs-toggle", "");
